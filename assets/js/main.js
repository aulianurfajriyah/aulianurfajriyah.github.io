...
/*==================== ENTHUSIASM MODAL ====================*/
const modalViews = document.querySelectorAll('.enthusiasm__modal'),
      modalBtns = document.querySelectorAll('.enthusiasm__button'),
      modalCloses = document.querySelectorAll('.enthusiasm__modal-close')
